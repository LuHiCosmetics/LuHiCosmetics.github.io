...
<div class="view">
	<div class="my__suggestion"><center><h1>💄💋👄🎉🎊<br>Hot Deal!<br>Luôn Khuyến Mãi!</h1></center><div>
		<section class="grid">
			<div class="product">
				<div class="product__info">
					<img class="product__image" src="images/The_Alchemist.png" alt="The Alchemist" />
					<h3 class="product__title">KOSE SOFTYMO CLEANSING OIL</h3>
					<span class="product__author highlight">Tẩy trang dạng dầu của thương hiệu mỹ phẩm nội địa Nhật Bản. </span>
			...
			<div class="product">
				<div class="product__info">
					...
					<h3 class="product__title">Thuốc bổ gan trắng - Hepalyse Plus</h3>
					<span class="product__author highlight">Ổn định màng tế bào gan, ngăn cản sự xâm nhập của các chất độc vào gan.</span>
			...
			<div class="product">
				<div class="product__info">
					...
					<h3 class="product__title">Sản phẩm a4</h3>
					<span class="product__author highlight">GH Creation Ex được biết đến với tác dụng tăng chiều cao hiệu quả</span>
			...
			<div class="product">
				<div class="product__info">
					...
					<h3 class="product__title">Sản phẩm a5</h3>
					<span class="product__author highlight">GH Creation Ex được biết đến với tác dụng tăng chiều cao hiệu quả</span>
			...
			<div class="product">
				<div class="product__info">
					...
					<h3 class="product__title">Sản phẩm a6</h3>
					<span class="product__author highlight">GH Creation Ex được biết đến với tác dụng tăng chiều cao hiệu quả</span>
			...
			<div class="product">
				<div class="product__info">
					...
					<h3 class="product__title">Sản phẩm a7</h3>
					<span class="product__author highlight">GH Creation Ex được biết đến với tác dụng tăng chiều cao hiệu quả</span>
			...
			<div class="product">
				<div class="product__info">
					...
					<h3 class="product__title">Sản phẩm a8</h3>
					<span class="product__author highlight">GH Creation Ex được biết đến với tác dụng tăng chiều cao hiệu quả</span>
			...
			<div class="product">
				<div class="product__info">
					...
					<h3 class="product__title">Sản phẩm a9</h3>
					<span class="product__author highlight">GH Creation Ex được biết đến với tác dụng tăng chiều cao hiệu quả</span>
			...
			<div class="product">
				<div class="product__info">
					...
					<h3 class="product__title">Sản phẩm a10</h3>
					<span class="product__author highlight">GH Creation Ex được biết đến với tác dụng tăng chiều cao hiệu quả</span>
